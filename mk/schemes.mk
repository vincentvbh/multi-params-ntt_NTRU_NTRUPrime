...
tests: elf/$(2)_test.elf elf/$(2)_speed.elf elf/$(2)_speed168MHz.elf elf/$(2)_stack.elf
tests-bin: bin/$(2)_test.bin bin/$(2)_speed.bin bin/$(2)_speed168MHz.bin bin/$(2)_stack.bin
tests-hex: bin/$(2)_test.hex bin/$(2)_speed.hex bin/$(2)_speed168MHz.hex bin/$(2)_stack.hex
